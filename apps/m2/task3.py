...
def find_all_tags(input_path):
    """
    Read an HTML/XML file, parse it, find all the tags.
    """
    try:
        ...
        soup = BeautifulSoup(content, parser,parse_only=all_tags)
